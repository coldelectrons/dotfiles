...
" Replaced by Kelly 18.09.02 with the line that follows... 
" noremap <buffer> <F1> :if strpart(getline(1),0,6) !~ "^<\[Hh]\[Tt]\[Mm]\[Ll]>"<CR>0read $VIMRUNTIME\scripts\html-template.vim<CR>normal /<\/title\\|<\/TITLE<CR><CR>:endif<CR>3jf>a
noremap <buffer> <F1> :if strpart(getline(1),0,6) !~ "^<\[Hh]\[Tt]\[Mm]\[Ll]>"<CR>0read $VIMRUNTIME\scripts\html-template.vim<CR>normal /<\/title\\|<\/TITLE<CR><CR>:endif<CR>3jf>1G/<title>f<mt/body$mb/"author"fKma/description3f"md/keywords3f"mk'bo
...
" The following two lines interfered with é and è, so I removed them: (jkc 18.09.02)
...
"inoremap <buffer> ;co <code></code><Esc>F<i
...
"inoremap <buffer> ;l <li></li><Esc>4hi
"inoremap <buffer> ;o <ol><Esc>o</ol><Esc>O
"inoremap <buffer> ;p <p>
"inoremap <buffer> ;P <pre></pre><Esc>F<i
"inoremap <buffer> ;s <strong></strong><Esc>F<i
inoremap <buffer> ;S <div class="slide"><Esc>o<Esc>o</div><Esc>kA
...
"inoremap <buffer> ;u <ul><Esc>o<Esc>o</ul><Esc>kA
inoremap <buffer> ;U <ul class="incremental"><Esc>o<Esc>o</ul><Esc>kA
...
inoremap <buffer> ;w <a title="" style="color: #000000; cursor: link; text-decoration: none;"><Esc>o<Esc>o</a><Esc>kkf"a
inoremap <buffer> ;< &lt;
inoremap <buffer> ;> &gt;
...
"nnoremenu 40.401 Html.template\ \ \ \ \ \ \ \ F1 :if strpart(getline(1),0,6) !~ "^<\[Hh]\[Tt]\[Mm]\[Ll]>"<CR>0read $VIMRUNTIME\scripts\html-template.vim<CR>normal /<\/title\\|<\/TITLE<CR><CR>:endif<CR>i
